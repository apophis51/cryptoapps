...
async function main() {
    ...
    let winningWallet = new ethers.Wallet('0x5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a', provider);
    ...
    const amountToSend = ethers.utils.parseEther('.0002'); // Sending 0.1 Ether
    ...
    let testAcc = '0x70997970C51812dc3A010C7d01b50e0d17dc79C8'
    try{
    ...
    const tx = await game.playGame (9,randomInt, testAcc)
